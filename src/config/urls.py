...
base_urlpatterns = patterns('',
    ...
    url(r'^pearson/', include('pearson.urls', namespace='pearson')),
    url(r'^pearson/requests/', include('pearson_requests.urls', namespace='pearson_requests')),
    url(r'^pearson/tools/dcl/', include('pearson_dcl.urls', namespace='pearson_dcl')),
