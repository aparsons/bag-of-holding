...
urlpatterns = patterns('',
    ...
    url(r'^requests/$', views.dashboard_requests, name='dashboard.requests'),
    url(r'^requests/(?P<engagement_request_id>\d+)$', views.dashboard_requests_detail, name='dashboard.requests.detail'),
    url(r'^requests/(?P<engagement_request_id>\d+)/edit/$', views.dashboard_requests_edit, name='dashboard.requests.edit'),
