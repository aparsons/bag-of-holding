...
class EngagementAddForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['start_date', 'end_date', 'description', 'requestor', 'version']
        labels = {
...
class EngagementEditForm(forms.ModelForm):
    class Meta:
        model = models.Engagement
        fields = ['status', 'start_date', 'end_date', 'description', 'requestor', 'version']
        labels = {
            'start_date': 'Scheduled start date',
            'end_date': 'Scheduled end date'
        }
...
# Engagement Request Subscription

class EngagementRequestSubscriptionForm(forms.ModelForm):
    class Meta:
        model = models.EngagementRequestSubscription
