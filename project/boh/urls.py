...
urlpatterns = [
    ...
    url(r'^manage/data-elements/$', views.management_data_elements, name='management.data_elements'),
    url(r'^manage/data-elements/add/$', views.management_data_elements_add, name='management.data_elements.add'),
    url(r'^manage/data-elements/(?P<data_element_id>\d+)/edit/$', views.management_data_elements_edit, name='management.data_elements.edit'),
    url(r'^manage/data-elements/(?P<data_element_id>\d+)/delete/$', views.management_data_elements_delete, name='management.data_elements.delete'),
    url(r'^manage/service-level-agreements/$', views.management_service_level_agreements, name='management.service_level_agreements'),
    url(r'^manage/service-level-agreements/add/$', views.management_service_level_agreements_add, name='management.service_level_agreements.add'),
    url(r'^manage/service-level-agreements/(?P<service_level_agreement_id>\d+)/edit/$', views.management_service_level_agreements_edit, name='management.service_level_agreements.edit'),
    url(r'^manage/service-level-agreements/(?P<service_level_agreement_id>\d+)/delete/$', views.management_service_level_agreements_delete, name='management.service_level_agreements.delete'),
