...
def dashboard_personal(request):
    ...
    pending_activities = activities.filter(
        status=models.Engagement.PENDING_STATUS)
...
def dashboard_team(request):
    ...
    activities_by_user = User.objects.all().prefetch_related(Prefetch(
            'activity_set',
    ...
    engagements = models.Engagement.objects.all().prefetch_related(Prefetch(
        'activity_set',
        queryset=models.Activity.objects.all()
        .select_related('activity_type__name')
        .annotate(user_count=Count('users'))
        )
    ).select_related('application__name').annotate(
        comment_count=Count('engagementcomment'))

    open_engagements = engagements.filter(
        status=models.Engagement.OPEN_STATUS)
    ...
    empty_engagements = models.Engagement.objects\
...
def dashboard_reports_download(request):
    ...
    if report_type == 'engagement_coverage':
        ...
        if form.is_valid():
            ...
            return (
                reports.EngagementCoverageReport(
                    file_name,
        ...
        if form.is_valid():
            ...
            return (
                reports.ThreadFixSummaryReport(
                    file_name,
                    form.cleaned_data['format'],
                    form.cleaned_data['organizations'],
                    request.user).response()
        ...
        if form.is_valid():
            ...
            return (
                reports.AppSummaryReport(
                    file_name,
                    form.cleaned_data['format'],
                    form.cleaned_data['applications'],
                    request.user).response()
            )
    messages.error(
        request,
        _('There was a problem downloading the report.'),
        extra_tags=random.choice(error_messages)
    )
...
def management_application_tags(request):
    ...
    return render(
        request,
        'boh/management/application_tags/application_tags.html',
        {
            'tags': tags,
            'active_top': 'management',
            'active_side': 'tags'
...
def management_application_tags_add(request):
    ...
    if request.method == 'POST':
        if add_form.is_valid():
            ...
            messages.success(
                request,
                _('You successfully added the "' + tag.name + '" application \
                    tag.'),
                extra_tags=random.choice(success_messages)
            )
            return redirect('boh:management.tags')
        else:
            messages.error(
                request,
                _('There was a problem creating this application tag.'),
                extra_tags=random.choice(error_messages)
            )
...
def management_application_tags_edit(request, tag_id):
    ...
    if request.method == 'POST':
        if edit_form.is_valid():
            ...
            messages.success(
                request,
                _('You successfully updated the "' + tag.name + '" application\
                    tag.'),
                extra_tags=random.choice(success_messages)
            )
            return redirect('boh:management.tags')
            ...
            messages.error(
                request,
                _('There was a problem updating this application tag.'),
                extra_tags=random.choice(error_messages)
            )
...
def management_application_tags_delete(request, tag_id):
    ...
    if form.is_valid():
        ...
        messages.success(
            request,
            _('You successfully deleted the "' + tag.name + '" application \
                tag.'),
            extra_tags=random.choice(success_messages)
        )
        return redirect('boh:management.tags')
        ...
        messages.error(
            request,
            _('There was a problem deleting this application tag.'),
            extra_tags=random.choice(error_messages)
        )
...
def management_activity_types(request):
    ...
    return render(
        request,
        'boh/management/activity_types/activity_types.html',
        {
...
def management_activity_types_add(request):
    ...
    if request.method == 'POST':
        if activity_type_form.is_valid():
            ...
            messages.success(
                request,
                _('You successfully created the "' + activity_type.name + '" \
                    activity type.'),
                extra_tags=random.choice(success_messages)
            )
            ...
            messages.error(
                request,
                _('There was a problem creating this activity type.'),
                extra_tags=random.choice(error_messages)
            )
...
def management_activity_types_documentation(request, activity_type_id):
    ...
    return render(
        request,
        'boh/management/activity_types/documentation.html',
        {
...
def management_activity_types_edit(request, activity_type_id):
    ...
    activity_type_form = forms.ActivityTypeForm(
        request.POST or None, instance=activity_type
    )
    ...
    if request.method == 'POST':
        if activity_type_form.is_valid():
            ...
            messages.success(
                request,
                _('You successfully updated the "' + activity_type.name + '" \
                    activity type.'),
                extra_tags=random.choice(success_messages)
            )
            return redirect('boh:management.activity_types')
            ...
            messages.error(
                request,
                _('There was a problem updating this activity type.'),
                extra_tags=random.choice(error_messages)
            )
...
def management_activity_types_delete(request, activity_type_id):
    ...
    if form.is_valid():
        ...
        messages.success(
            request,
            _('You successfully deleted the "' + activity_type.name + '" \
                activity type.'),
            extra_tags=random.choice(success_messages)
        )
        return redirect('boh:management.activity_types')
        ...
        messages.error(
            request,
            _('There was a problem deleting this activity type.'),
            extra_tags=random.choice(error_messages)
        )
...
def management_services_threadfix_add(request):
    ...
    if request.method == 'POST':
        if threadfix_form.is_valid():
            ...
            messages.success(
                request,
                _('You successfully created the "' + threadfix.name + '" \
                    ThreadFix service.'),
                extra_tags=random.choice(success_messages)
            )
            ...
            messages.error(
                request,
                _('There was a problem creating this ThreadFix service.'),
                extra_tags=random.choice(error_messages)
            )
...
def management_services_threadfix_edit(request, threadfix_id):
    ...
    threadfix_form = forms.ThreadFixForm(
        request.POST or None, instance=threadfix
    )
    ...
    if request.method == 'POST':
        if threadfix_form.is_valid():
            ...
            messages.success(
                request,
                _('You successfully updated the "' + threadfix.name + '" \
                    ThreadFix service.'),
                extra_tags=random.choice(success_messages)
            )
            return redirect('boh:management.services')
            ...
            messages.error(
                request,
                _('There was a problem updating this ThreadFix service.'),
                extra_tags=random.choice(error_messages)
            )
...
def management_services_threadfix_test(request, threadfix_id):
    ...
    api = tf_api.ThreadFixAPI(
        host=threadfix.host,
        api_key=threadfix.api_key,
        verify_ssl=threadfix.verify_ssl
    )
    ...
    if response.success:
        messages.success(
            request,
            _('Everything appears to be working correctly for the \
                "' + threadfix.name + '" ThreadFix service.'),
            extra_tags=random.choice(success_messages)
        )
    else:
        messages.error(
            request,
            _('An error occurred when testing "' + threadfix.name + '". \
                ' + response.message),
            extra_tags=random.choice(error_messages)
        )
...
def management_services_threadfix_import(request, threadfix_id):
    ...
    ImportFormSet = formset_factory(
        forms.ThreadFixApplicationImportForm,
        extra=0
    )
    ...
    if request.method == 'GET':
        ...
        if teams_response.success:
            ...
            for json_team in teams_response.data:
                for json_application in json_team['applications']:
                    application = {
                        'team_id': json_team['id'],
                        'team_name': json_team['name'][:128],
                        'application_name': json_application['name'][:128],
                        'application_id': json_application['id']
                    }
            ...
            messages.error(
                request,
                _('An error occurred when importing from \
                    "' + threadfix.name + '". ' + teams_response.message),
                extra_tags=random.choice(error_messages)
            )
            return redirect('boh:management.services')
        ...
        if import_formset.is_valid():
            for form in import_formset.cleaned_data:
                if form['organization']:
                    application = models.Application(
                        ...
                        threadfix=threadfix,
                        threadfix_team_id=form['team_id'],
                        threadfix_application_id=form['application_id']
                    )
                    try:
                        application.save()
            ...
            if len(imported_applications) > 0 or len(failed_applications) > 0:
                return render(
                    request,
                    'boh/management/threadfix/import_done.html',
                    {
                        'threadfix': threadfix,
                ...
                messages.warning(
                    request,
                    _('No applications were imported from \
                        "' + threadfix.name + '".'),
                    extra_tags=random.choice(error_messages)
                )
        else:
            messages.error(
                request,
                _('An error occurred when saving the import from \
                    "' + threadfix.name + '".'),
                extra_tags=random.choice(error_messages)
            )
...
def management_services_threadfix_delete(request, threadfix_id):
    ...
    if form.is_valid():
        ...
        messages.success(
            request,
            _('You successfully deleted the "' + threadfix.name + '" \
                ThreadFix service.'),
            extra_tags=random.choice(success_messages)
        )
        return redirect('boh:management.services')
        ...
        messages.error(
            request,
            _('There was a problem deleting this ThreadFix service.'),
            extra_tags=random.choice(error_messages)
        )
...
def user_profile(request):
    ...
    if request.method == 'POST':
        if profile_form.is_valid():
            ...
            messages.success(
                request,
                _('You successfully updated your profile.'),
                extra_tags=random.choice(success_messages)
            )
        else:
            messages.error(
                request,
                _('There was a problem updating your profile.'),
                extra_tags=random.choice(error_messages)
            )
...
def user_change_password(request):
    ...
    if request.method == 'POST':
        if password_form.is_valid():
            ...
            messages.success(
                request,
                _('You successfully changed your password.'),
                extra_tags=random.choice(success_messages)
            )
        else:
            messages.error(
                request,
                _('There was a problem changing your password.'),
                extra_tags=random.choice(error_messages)
            )
...
def organization_settings_general(request, organization_id):
    ...
    form = forms.OrganizationSettingsGeneralForm(
        request.POST or None, instance=organization
    )
    ...
    if request.method == 'POST':
        if form.is_valid():
            ...
            messages.success(
                request,
                _('You successfully updated this organization\'s general \
                    information.'),
                extra_tags=random.choice(success_messages))
        else:
            messages.error(
                request,
                _('There was a problem updating this organization\'s general \
                    information.'),
                extra_tags=random.choice(error_messages))
...
def organization_settings_people(request, organization_id):
    ...
    people_form = forms.OrganizationSettingsPeopleForm(
        request.POST or None, instance=organization
    )
    ...
    if request.method == 'POST':
        if people_form.is_valid():
            ...
            messages.success(
                request,
                _('You successfully updated this organization\'s associated \
                    people.'),
                extra_tags=random.choice(success_messages))
        else:
            messages.error(
                request,
                _('There was a problem updating this organization\'s \
                    associated people.'),
                extra_tags=random.choice(error_messages))
...
def organization_settings_danger(request, organization_id):
    ...
    form = forms.OrganizationDeleteForm(
        request.POST or None, instance=organization
    )
    ...
    if request.method == 'POST' and form.is_valid():
        ...
        messages.success(
            request,
            _('You successfully deleted the "' + organization.name + '" \
                organization.'),
            extra_tags=random.choice(success_messages))
...
def organization_add(request):
    ...
    if form.is_valid():
        ...
        messages.success(
            request,
            _('You successfully created this organization.'),
            extra_tags=random.choice(success_messages)
        )
...
def application_list(request):
    ...
    application_filter = filters.ApplicationFilter(
        request.GET,
        queryset=models.Application.objects.all()
        .select_related('organization__name').prefetch_related('tags')
    )
    ...
    show_advanced = False
    if (
        request.GET.get('platform') or request.GET.get('lifecycle') or
        request.GET.get('origin') or request.GET.get('technologies') or
        request.GET.get('regulations') or request.GET.get('tags') or
        request.GET.get('service_level_agreements') or
        request.GET.get('asvs_level') or
        (
            request.GET.get('external_audience') and
            request.GET.get('external_audience') is not '1'
        ) or
        (
            request.GET.get('internet_accessible') and
            request.GET.get('internet_accessible') is not '1'
        )
       ):
        show_advanced = True
...
def application_engagements(request, application_id):
    application = get_object_or_404(
        models.Application.objects.select_related('organization'),
        pk=application_id
    )

    engagements = application.engagement_set.prefetch_related(Prefetch(
        'activity_set',
        queryset=models.Activity.objects
        .all()
        .select_related('activity_type__name'))
    ...
    closed_engagements = engagements.filter(
        status=models.Engagement.CLOSED_STATUS
    ).order_by('-end_date')
...
def application_people_add(request, application_id):
    ...
    relation_form.fields['person'].queryset = models.Person.objects.exclude(
        application__id=application.id
    )
    ...
    if request.method == 'POST':
        if relation_form.is_valid():
            ...
            try:
                ...
                messages.error(
                    ...
                    (
                        ...
                        _(' is already related to this application.')
                    ),
                    extra_tags=random.choice(error_messages)
                )
            else:
            ...
            messages.error(
                request,
                _('There was a problem saving the relation to this \
                    application.'),
                extra_tags=random.choice(error_messages)
            )
...
def application_people_edit(request, application_id, relation_id):
    ...
    relation_form = forms.PersonRelationForm(
        request.POST or None, instance=relation
    )
    relation_form.fields['person'].queryset = models.Person.objects.exclude(
        Q(application__id=application.id) & ~Q(id=relation.person.id)
    )
...
def application_people_delete(request, application_id, relation_id):
    ...
    if delete_form.is_valid():
        ...
        messages.success(
            request,
            (
                _('You successfully disassociated ') +
                relation.person.first_name +
                ' ' +
                relation.person.last_name +
        ...
        messages.error(
            request,
            _('There was a problem disassociating ' +
                relation.person.first_name +
                ' ' +
                relation.person.last_name +
...
def application_add(request):
    ...
    if form.is_valid():
        ...
        messages.success(
            request,
            _('You successfully created this application.'),
            extra_tags=random.choice(success_messages)
        )
        return (
            redirect('boh:application.overview', application_id=application.id)
        )
...
def application_settings_general(request, application_id):
    ...
    general_form = forms.ApplicationSettingsGeneralForm(
        instance=application
    )
    organization_form = forms.ApplicationSettingsOrganizationForm(
        instance=application
    )
    ...
    if request.method == 'POST':
        if 'submit-general' in request.POST:
            ...
            if general_form.is_valid():
                ...
                messages.success(
                    request,
                    _('You successfully updated this application\'s general \
                        information.'),
                    extra_tags=random.choice(success_messages)
                )
            ...
            if organization_form.is_valid():
                ...
                messages.success(
                    request,
                    _('You successfully updated this application\'s \
                        organization.'),
                    extra_tags=random.choice(success_messages)
                )
...
def application_settings_metadata(request, application_id):
    ...
    metadata_form = forms.ApplicationSettingsMetadataForm(
        instance=application
    )
    technologies_form = forms.ApplicationSettingsTechnologiesForm(
        instance=application
    )
    regulations_form = forms.ApplicationSettingsRegulationsForm(
        instance=application
    )
    tags_form = forms.ApplicationSettingsTagsForm(
        instance=application
    )
    ...
    if 'submit-metadata' in request.POST:
        ...
        if metadata_form.is_valid():
            ...
            messages.success(
                request,
                _('You successfully updated this application\'s metadata.'),
                extra_tags=random.choice(success_messages)
            )
        else:
            messages.error(
                request,
                _('There was a problem updating this application\'s \
                    metadata.'),
                extra_tags=random.choice(error_messages)
            )
    ...
    if 'submit-regulations' in request.POST:
        ...
        if regulations_form.is_valid():
            ...
            messages.success(
                request,
                _('You successfully updated this application\'s regulations.'),
                extra_tags=random.choice(success_messages)
            )
        else:
            messages.error(
        ...
        if tags_form.is_valid():
            ...
            messages.success(
                request,
                _('You successfully updated this application\'s tags.'),
                extra_tags=random.choice(success_messages)
            )
        else:
            messages.error(
                request,
                _('There was a problem updating this application\'s tags.'),
                extra_tags=random.choice(error_messages)
            )
...
def application_settings_data_elements(request, application_id):
    ...
    data_elements_form = forms.ApplicationSettingsDataElementsForm(
        request.POST or None, instance=application
    )
    dcl_override_form = forms.ApplicationSettingsDCLOverrideForm(
        instance=application
    )
    ...
    if request.method == 'POST':
        if data_elements_form.is_valid():
            ...
            messages.success(
                request,
                _('You successfully updated this application\'s data \
                    elements.'),
                extra_tags=random.choice(success_messages)
            )
        return (
            redirect('boh:application.settings.data-elements', application.id)
        )
...
def application_settings_service_level_agreements(request, application_id):
    ...
    sla_form = forms.ApplicationSettingsServiceLevelAgreementForm(
    ...
    if request.method == 'POST':
        if sla_form.is_valid():
            ...
            messages.success(
                request,
                _('You successfully updated this application\'s service level \
                    agreements.'),
                extra_tags=random.choice(success_messages)
            )
        else:
            messages.error(
                request,
                _('There was a problem updating this application\'s service \
                    level agreements.'),
                extra_tags=random.choice(error_messages)
            )
    ...
    return render(
        request,
        'boh/application/settings/service_level_agreements.html',
        {
            'application': application,
            'sla_form': sla_form,
            'active_top': 'applications',
...
def application_settings_data_elements_override(request, application_id):
    ...
    if dcl_override_form.is_valid():
        ...
        messages.success(
            request,
            _('This application\'s data classification override has been \
                updated.'),
            extra_tags=random.choice(success_messages)
        )
...
def application_settings_services(request, application_id):
    ...
    threadfix_form = forms.ApplicationSettingsThreadFixForm(
        instance=application
    )
    ...
    if 'submit-threadfix' in request.POST:
        ...
        if threadfix_form.is_valid():
            ...
            messages.success(
                request,
                _('You successfully updated this application\'s ThreadFix \
                    information.'),
                extra_tags=random.choice(success_messages)
            )
...
def application_settings_owasp_asvs(request, application_id):
    ...
    if 'submit-asvs' in request.POST:
        asvs_form = forms.ApplicationSettingsASVSForm(
            request.POST,
            instance=application
        )
        if asvs_form.is_valid():
            ...
            messages.success(
                request,
                _('You successfully updated this application\'s ASVS \
                    information.'),
                extra_tags=random.choice(success_messages)
            )
...
def application_settings_custom_fields(request, application_id):
    ...
    formset = ApplicationCustomFieldValueFormSet(
        request.POST or None,
        instance=application
    )
    ...
    if formset.is_valid():
        ...
        messages.success(
            request,
            _('You successfully updated these custom fields.'),
            extra_tags=random.choice(success_messages)
        )
        return (
            redirect(
                'boh:application.settings.custom-fields',
...
def application_settings_danger(request, application_id):
    ...
    if request.method == 'POST' and form.is_valid():
        ...
        messages.success(
            request,
            _('You successfully deleted the "' + application.name + '" \
                application.'),
            extra_tags=random.choice(success_messages)
        )
...
def environment_add(request, application_id):
    ...
    if form.is_valid():
        ...
        messages.success(
            request,
            _('You successfully created this environment.'),
            extra_tags=random.choice(success_messages)
        )
        return (
            redirect(
                'boh:application.environments',
                application_id=application.id
            )
        )
...
def environment_edit_general(request, environment_id):
    ...
    form = forms.EnvironmentEditForm(
        request.POST or None,
    ...
    if form.is_valid():
        ...
        messages.success(
            request,
            _('You successfully updated this environment.'),
            extra_tags=random.choice(success_messages)
        )
        return (
            redirect(
                'boh:environment.edit.general',
...
def environment_edit_locations(request, environment_id):
    ...
    formset = EnvironmentLocationInlineFormSet(
        request.POST or None,
        instance=environment
    )
    ...
    if formset.is_valid():
        ...
        messages.success(
            request,
            _('You successfully updated these locations.'),
            extra_tags=random.choice(success_messages)
        )
        return (
            redirect(
                'boh:environment.edit.locations',
                environment_id=environment.id
            )
        )
...
def environment_edit_credentials(request, environment_id):
    ...
    formset = EnvironmentCredentialsInlineFormSet(
        request.POST or None,
        instance=environment
    )
    ...
    if formset.is_valid():
        ...
        messages.success(
            request,
            _('You successfully updated these credentials.'),
            extra_tags=random.choice(success_messages)
        )
        return (
            redirect(
                'boh:environment.edit.credentials',
                environment_id=environment.id
            )
        )
...
def environment_edit_danger(request, environment_id):
    ...
    if request.method == 'POST' and form.is_valid():
        ...
        messages.success(
            request,
            _('You successfully deleted the "' + environment.
                get_environment_type_display() + '" environment.'),
            extra_tags=random.choice(success_messages)
        )
        return (
            redirect(
...
def engagement_detail(request, engagement_id):
    ...
    pending_activities = engagement.activity_set.filter(
        status=models.Activity.PENDING_STATUS
    )
    open_activities = engagement.activity_set.filter(
        status=models.Activity.OPEN_STATUS
    )
    closed_activities = engagement.activity_set.filter(
        status=models.Activity.CLOSED_STATUS
    )
...
def engagement_add(request, application_id):
    ...
    if request.method == 'POST' and form.is_valid():
        ...
        messages.success(
            request,
            _('You successfully created this engagement.'),
            extra_tags=random.choice(success_messages)
        )
        return (
            redirect('boh:engagement.detail', engagement_id=engagement.id)
        )
    else:
...
def engagement_edit(request, engagement_id):
    ...
    if request.method == 'POST' and form.is_valid():
        ...
        messages.success(
            request,
            _('You successfully updated this engagement.'),
            extra_tags=random.choice(success_messages)
        )
...
def engagement_status(request, engagement_id):
    ...
    if status_form.is_valid():
        ...
        messages.success(
            request,
            _('You successfully updated this engagement\'s status \
                to ' + engagement.get_status_display().lower() + '.'),
            extra_tags=random.choice(success_messages)
        )
...
def engagement_delete(request, engagement_id):
    ...
    if form.is_valid():
        ...
        messages.success(
            request,
            _('You successfully deleted the engagement.'),
            extra_tags='Boom!'
        )
...
def engagement_comment_add(request, engagement_id):
    ...
    if form.is_valid():
        ...
        messages.success(
            request,
            _('You successfully added a comment to this engagement.'),
            extra_tags=random.choice(success_messages)
        )
        return (
            redirect(
                reverse(
                    'boh:engagement.detail',
...
def activity_add(request, engagement_id):
    ...
    if request.method == 'POST' and form.is_valid():
        ...
        activity.save()
        form.save_m2m()  # http://bit.ly/2iTje9H
        messages.success(
            request,
            _('You successfully added this activity.'),
            extra_tags=random.choice(success_messages)
        )
...
def activity_edit(request, activity_id):
    ...
    if request.method == 'POST' and form.is_valid():
        ...
        messages.success(
            request,
            _('You successfully updated this activity.'),
            extra_tags=random.choice(success_messages)
        )
        return redirect('boh:activity.detail', activity_id=activity.id)
...
def activity_status(request, activity_id):
    ...
    if status_form.is_valid():
        ...
        messages.success(
            request,
            _('You successfully updated this activity\'s status \
                to ' + activity.get_status_display().lower() + '.'),
            extra_tags=random.choice(success_messages)
        )
...
def activity_delete(request, activity_id):
    ...
    if form.is_valid():
        ...
        messages.success(
            request,
            _('You successfully deleted the activity.'),
            extra_tags=random.choice(success_messages)
        )
...
def activity_comment_add(request, activity_id):
    ...
    if form.is_valid():
        ...
        messages.success(
            request,
            _('You successfully added a comment to this activity.'),
            extra_tags=random.choice(success_messages)
        )
        return (
            redirect(
...
def person_add(request):
    ...
    if form.is_valid():
        ...
        messages.success(
            request,
            _('You successfully created this person.'),
            extra_tags=random.choice(success_messages)
        )
...
def person_edit(request, person_id):
    ...
    if request.method == 'POST':
        if form.is_valid():
            ...
            messages.success(
                request,
                _('You successfully updated ' + person.first_name + ' ' +
                    person.last_name + '.'),
                extra_tags=random.choice(success_messages)
            )
            ...
            messages.error(
                request,
                _('There was a problem updating' + person.first_name + ' ' +
                    person.last_name + '.'),
                extra_tags=random.choice(error_messages)
            )
...
def person_delete(request, person_id):
    ...
    if form.is_valid():
        ...
        messages.success(
            request,
            _('You successfully deleted ' + person.first_name + ' ' +
                person.last_name + '.'),
            extra_tags=random.choice(success_messages)
        )
        return redirect('boh:person.list')
