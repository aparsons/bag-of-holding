...
class TagTests(TestCase):
    ...
    def test_str(self):
        self.assertEqual(
            'Name',
            models.Tag(name='Name', color='FFFFFF').__str__()
        )
...
class DataElementTests(TestCase):
    ...
    def test_str(self):
        element = models.DataElement(
            name='Test',
            description='',
            category=models.DataElement.GLOBAL_CATEGORY,
            weight=5
        )
...
class TechnologyTests(TestCase):
    ...
    def setUp(self):
        self.tech_1 = models.Technology(
            name='Python',
            category=models.Technology.PROGRAMMING_LANGUAGE_CATEGORY,
...
class RegulationTests(TestCase):
    ...
    def setUp(self):
        self.reg_1 = models.Regulation(
            name='PCI Data Security Standard',
            acronym='PCI DSS',
            category=models.Regulation.FINANCE_CATEGORY,
...
class ServiceLevelAgreementTests(TestCase):
    ...
    def setUp(self):
        self.sla_1 = models.ServiceLevelAgreement(
            name='Test',
...
class ApplicationTests(TestCase):
    ...
    def setUp(self):
        ...
        self.de_fname = models.DataElement(
            name='fname',
            category=models.DataElement.PERSONAL_CATEGORY,
            weight=2.0
        )
        self.de_fname.save()

        self.de_lname = models.DataElement(
            name='lname',
            category=models.DataElement.GLOBAL_CATEGORY,
            weight=10.0
        )
        ...
        self.de_gender = models.DataElement(
            name='gender',
            category=models.DataElement.PERSONAL_CATEGORY,
            weight=3.0
        )
        ...
        self.de_age = models.DataElement(
            name='age',
            category=models.DataElement.PERSONAL_CATEGORY,
            weight=15.0
        )
        ...
        self.de_edu = models.DataElement(
            name='education',
            category=models.DataElement.PERSONAL_CATEGORY,
            weight=100.0
        )
        ...
        self.app_2.created_date = timezone.utc.localize(
    ...
    def test_data_classification_level_1(self):
        ...
        self.assertEqual(
            models.Application.DCL_1,
            self.app_1.data_classification_level()
        )
    ...
    def test_data_classification_level_2(self):
        ...
        self.assertEqual(
            models.Application.DCL_2,
            self.app_2.data_classification_level()
        )
    ...
    def test_data_classification_level_3(self):
        ...
        self.assertEqual(
            models.Application.DCL_3,
            self.app_3.data_classification_level()
        )
    ...
    def test_data_classification_level_4(self):
        ...
        self.assertEqual(
            models.Application.DCL_4,
            self.app_4.data_classification_level()
        )
...
class ThreadFixMetricsTests(TestCase):
    ...
    def setUp(self):
        self.tfm_1 = models.ThreadFixMetrics(
            critical_count=1,
            high_count=4,
            medium_count=16,
            low_count=10,
...
class EnvironmentTests(TestCase):
    ...
    def setUp(self):
        ...
        self.env_1 = models.Environment(
            environment_type=models.Environment.PRODUCTION_ENVIRONMENT,
...
class EnvironmentLocationTests(TestCase):
    ...
    def setUp(self):
        ...
        self.el_1 = models.EnvironmentLocation(
...
class EnvironmentCredentialsTests(TestCase):
    ...
    def setUp(self):
        ...
        self.ec_1 = models.EnvironmentCredentials(
            username='user',
            password='pass123',
            environment=self.env_1
        )
...
class ActivityTests(TestCase):
    ...
    def setUp(self):
        ...
        self.ac_1 = models.Activity(
            engagement=self.en_1,
            activity_type=self.at_1
        )
        self.ac_1.save()
    ...
    def test_save_close_parent_engagement_solo(self):
        ...
        self.ac_2 = models.Activity(
            engagement=self.en_2,
            activity_type=self.at_1
        )
        self.ac_2.save()
    ...
    def test_save_close_parent_engagement_multiple(self):
        ...
        self.ac_3 = models.Activity(
            engagement=self.en_3,
            activity_type=self.at_1
        )
        self.ac_3.save()
        ...
        self.ac_4 = models.Activity(
            engagement=self.en_3, activity_type=self.at_1
        )
        self.ac_4.save()
    ...
    def test_is_ready_for_work(self):
        ...
        self.ac_1.engagement.start_date = (
            datetime.date.today() + datetime.timedelta(days=1)
        )
        self.ac_1.engagement.save()
